...
#define LOCAL_PATH 					"/data/data/com.Source.S1_MCCPAY.MCCPAY/"
...
//PHQR
#define PHQR_INIT  137
#define PHQR_LOGON 138
...
//Wechat crash fix
#if 0
#define XML_SEND_SIZE           2000
#define XML_RECV_SIZE           2000
#else
#define XML_SEND_SIZE           3000
#define XML_RECV_SIZE           3000
#endif

#define XML_DATA_SIZE			3000

#define WECHAT_ALIPAY_REQUEST_QRCODE	1
#define WECHAT_ALIPAY_RETRIEVE_QRCODE	2
#define WECHAT_ALIPAY_CLOSE_QRCODE		4

#define WECHAT_HOST_INDEX		20
#define WECHAT_ISSUER_INDEX		10
#define WECHAT_AUTO_RETRIEVE			1
#define WECHAT_ALIPAY_MANUAL_RETRIEVE	2
#define WECHAT_ALIPAY_SEARCH_TXNID		1
#define WECHAT_ALIPAY_SEARCH_INVNO		2
#define WECHAT_ALIPAY_VOID				3
#define WECHAT_ALIPAY_REVERSAL          5 

// For Alipay -- sidumili
#define ALIPAY_HOST_INDEX		21
#define ALIPAY_ISSUER_INDEX		11

//int inAccountType;

// For GCash
#define GCASH_HOST_INDEX		22
#define GCASH_ISSUER_INDEX		12

// For Grab
#define GRAB_HOST_INDEX			23
#define GRAB_ISSUER_INDEX		13

// For UPI
#define UPI_HOST_INDEX			24
#define UPI_ISSUER_INDEX		14

//PHQR
#define PHQR_HOST_INDEX			25
#define PHQR_ISSUER_INDEX		15
...
typedef struct
{
	...
	int iXMLSearchType;
	BYTE szXMLSendData[XML_SEND_SIZE+1];
	int iXMLSendLen;
	BYTE szXMLReceiveData[XML_RECV_SIZE+1];
	int iXMLReceiveLen;
	...
	BYTE szXMLout_trade_no[50 + 1];
	BYTE szXMLtime_start[14 + 1];
	BYTE szXMLtotal_fee[13 + 1];
	BYTE szXMLcode_url[512+ 1];
	...
	BYTE szXMLout_transaction_id[50 + 1];
	...
	BYTE szTransactionID[21+1];
	BOOL fXMLTradeStateOK;
	BYTE szRefundID[32+1];
	BYTE szTradeState[32 + 1];
	// For Wechat -- sidumili
	...
	BYTE szTranYear[4 + 1];
	BOOL fBRVoidFlag;
	BYTE szIssuerLabel[16];
	
	//fix for crash
	//BYTE szXMLout_refund_no[32 + 1];
	BYTE szXMLout_refund_no[50 + 1];
	INT inQRPresented;
	BYTE szXMLrefund_status[256 + 1];
	BYTE szXMLrefund_fee[13 + 1];
	BOOL fStateTimeOut;
...
typedef struct
{
	...
	BYTE 		szXMLout_refund_no[32 + 1];
	INT         inQRPresented;
	BOOL        fRetrieveInList;

}RETRIEVE_DATA_TABLE;
	
RETRIEVE_DATA_TABLE srRetrieveRec;
...
#define V5S_MCCPAY "com.Source.S1_MCCPAY.MCCPAY"
...
#define GPRS_FAIL -2
#define ETHERNET_FAIL -3
#define WIFI_FAIL -4
#define MANUAL_SETTLE    137

#define CITAS_SERVICES	 	 138
#define MERCHANT_SERVICES	 139
#define MERCHANT_ORIENT	 	 140
...
#define ECR_INVALID_TRANS_RESP	"INVALID TRANSACTION"
...
#define d_CRADLE_COM1                        11
#define d_CRADLE_COM2                        12
#define d_CRADLE_COM3                          13
#define d_CRADLE_COM4                          14
