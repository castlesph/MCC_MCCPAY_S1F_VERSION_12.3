...
#include "..\DigitalWallet\POSGCash.h" // For GCash -- sidumili
#include "..\DigitalWallet\POSGrab.h" // For Grab -- sidumili
#include "..\DigitalWallet\POSUpi.h" // For Upi -- sidumili
...
Func_vdFunc stFunctionList_vdFunc[] = {
    ...
    {"inCTOS_WechatQRRequest", inCTOS_WechatQRRequest},
	{"inCTOS_WechatQRRetrieve", inCTOS_WechatQRRetrieve},
	{"inCTOS_AlipayQRRequest", inCTOS_AlipayQRRequest},
	{"inCTOS_AlipayQRRetrieve", inCTOS_AlipayQRRetrieve},
	{"inCTOS_GCashQRRequest", inCTOS_GCashQRRequest},
	{"inCTOS_GCashQRRetrieve", inCTOS_GCashQRRetrieve},
	{"inCTOS_GrabQRRequest", inCTOS_GrabQRRequest},
	{"inCTOS_GrabQRRetrieve", inCTOS_GrabQRRetrieve},
	{"inCTOS_UpiQRRequest", inCTOS_UpiQRRequest},
	{"inCTOS_UpiQRRetrieve", inCTOS_UpiQRRetrieve},
