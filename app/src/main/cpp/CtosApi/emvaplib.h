...
//pbAIDNoMatchOption for BANCNETS Dynamic Terminal Supported AID
#define d_BANCNETS_DYNAMIC_AID_OPTION_USE_OTHER_AID	                        0x00
#define d_BANCNETS_DYNAMIC_AID_OPTION_TERMINATED	                        0x01
...
#define d_EMVAPLIB_ERR_BANCNETS_SELECT_PREFER_AID_FAIL                      0x007A
...
#define d_EVENTID_BANCNETS_DYNAMIC_TERMIANL_SUPPORTED_AID				7
...
//variable for d_EVENTID_BANCNETS_DYNAMIC_TERMIANL_SUPPORTED_AID
typedef void (*EVENT_BANCNETS_DYNAMIC_TERMIANL_SUPPORTED_AID)(OUT BYTE *pbAID, OUT BYTE *pbAIDLen, OUT BYTE *pbAIDNoMatchOption);
