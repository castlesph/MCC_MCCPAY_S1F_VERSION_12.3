...
//
USHORT CTOS_CLSetConfiguration(USHORT usConfig, UINT uiValue);
USHORT CTOS_CLGetConfiguration(USHORT usConfig, UINT* uiValue);

//=============================================================================================================================
//
// Smart Card Functions & Memory Card Functions
//
//=============================================================================================================================
// value for bVolt
#define d_SC_5V								1
...
#define d_WIFI_CONFIG_TIMEOUT_CONNAP	8
...
USHORT CTOS_APFind(BYTE *baAPName, BYTE *baVersion);
...
void CTOS_LCDFBCapture(BOOL boEnable);
...
//
//=============================================================================================================================
#define d_MODEL_SATURN1000          12
#define d_MODEL_SATURN7000          13
#define d_MODEL_SATURN1000F2        14
#define d_MODEL_SATURN1000MINI      15
