...
#define d_RS232_TRY_AGAIN					0x0A07
...
//Redirect Error Code
#define d_FRD_ACCESS_EXTERNAL_DEVICE_NOT_PERFORMED		0x9001
#define d_FRD_FUNCTION_NOT_SUPPORT						0x9002
#define d_FRD_ENCRYPT_DATA_OVERFLOW						0x9003
#define d_FRD_DESCRYPT_DATA_EXCEED_BUF					0x9004
#define d_FRD_COMMADN_ID_NOT_FOUND						0x9005
#define d_FRD_PACK_CMD_DATA_OVERFLOW					0x9006
#define d_FRD_PACK_DLE_PROTOCOL_DATA_OVERFLOW			0x9007
#define d_FRD_RX_USER_CANCEL							0x9008
#define d_FRD_RX_TIMEOUT								0x9009
#define d_FRD_RX_DATA_OVERFLOW							0x900A
#define d_FRD_PROTOCOL_INVALID							0x900B
#define d_FRD_RX_DATA_PROTOCOL_FORMAT_ERROR				0x900C
#define d_FRD_RX_PARSE_DATA_OVERFLOW					0x900D
#define d_FRD_RSP_DATA_LEN_ERROR						0x900E
#define d_FRD_RSP_DATA_CMD_ID_ERROR						0x900F
#define d_FRD_RSP_DATA_SN_ERROR							0x9010
#define d_FRD_RSP_DATA_VERSION_ERROR					0x9011
#define d_FRD_RSP_DATA_OVERFLOW							0x9012
#define d_FRD_INIT_AUTHEN_KEY_TYPE_NOT_MATCH			0x9013
#define d_FRD_MUTUAL_AUTH_PROCESS_NOT_PERFORMED			0x9014
#define d_FRD_INIT_AUTHEN_CRYPTOGRAM_ERR				0x9015
#define d_FRD_MUTUAL_AUTHEN_SESSION_KEY_BUF_OVERFLOW	0x9016
#define d_FRD_DEVICE_PARAMETER_NOT_SUPPORT				0x9017
#define d_FRD_TK_CERT_NOT_EXIST							0x9018
#define d_FRD_PARAMETER_INVALID							0x9019
#define d_FRD_INPUT_DATA_SIZE_EXCEED					0x901A
#define d_FRD_EVENT_CMD_ID								0x901B
#define d_FRD_EVENT_CMD_CANCEL							0x901C
#define d_FRD_CONNECT_NOT_READY							0x901D
#define d_FRD_REBOOT_BUSY								0x901F
#define d_SC_INEFFECTIVE_CMD							0x9107
#define d_TASK_BUSY										0x9108

//Redirect Error Code for printer
#define d_PRINTER_MALLOC_FAIL							0xD000
#define d_PRINTER_DATA_SIZE_ERROR						0xD001
#define d_PRINTER_OPEN_FILE_ERROR						0xD002
#define d_PRINTER_CHECK_LEN_ERROR						0xD003
