...
//For bTxnType in EMV_TXNDATA
#define d_TXN_TYPE_GOODS_SERVICES                                      0x00
#define d_TXN_TYPE_CASH                                                0x01
#define d_TXN_TYPE_CASHBACK                                            0x09
#define d_TXN_TYPE_INQUIRY                                             0x30
#define d_TXN_TYPE_TRANSFER                                            0x40
#define d_TXN_TYPE_PAYMENT                                             0x50
#define d_TXN_TYPE_ADMINISTRATIVE                                      0x95
#define d_TXN_TYPE_CASH_DEPOSIT                                        0x21
	
//For value of Account Type, that is set to Tag 5F57 
#define d_ACCOUNT_TYPE_DEFAULT_UNSPECIFIED                             0x00
#define d_ACCOUNT_TYPE_SAVINGS                                         0x10
#define d_ACCOUNT_TYPE_CHEQUE_DEBIT                                    0x20
#define d_ACCOUNT_TYPE_CREDIT                                          0x30

//VERIFY Command Status
#define d_VERIFY_CMD_PERFORMED                                         0x00
#define d_VERIFY_CMD_NOT_PERFORMED                                     0x01
#define d_VERIFY_CMD_APDU_FAIL                                         0x02
	
//Cardholder Selection & Confirmation Mode
#define d_EMVAPLIB_CARDHOLDER_SEL_CONF_SUPPORT                         0x00
#define d_EMVAPLIB_CARDHOLDER_SEL_CONF_NOT_SUPPORT                     0x11
...
//PINPad Info
#define d_EMVAPLIB_PINPAD_INFO_GETPIN_OK								0xA5
#define d_EMVAPLIB_PINPAD_INFO_GETPIN_TIMEOUT							0xA6
#define d_EMVAPLIB_PINPAD_INFO_GETPIN_CANCEL							0xA7
#define d_EMVAPLIB_PINPAD_INFO_GETPIN_CANCEL_BY_API						0xA8
...
#define d_EMVAPLIB_ERR_NOT_INITIALIZE                                   0x0112
#define d_EMVAPLIB_ERR_CARDHOLDER_SEL_CONF_BUFFER_ERROR                 0x0113
#define d_EMVAPLIB_ERR_CARDHOLDER_SEL_CONF_FAIL                         0x0114
#define d_EMVAPLIB_ERR_INVALID_STRUCT_VERSION                           0x0116
...
#define d_EMVAPLIB_ERR_SEL_INDEX_NOT_FIND                               0x020F
...
#define d_EMVAPLIB_ERR_EVENT_CVM_NO_PIN_ACTION_STOP_TXN					0x030F
...
#define d_EMVAPLIB_ERR_CAS_FIN_SEL_CONFIRM_STOP                         0x108A
...
#define d_EMVAPLIB_ERR_SECURE_MODULE_ACCESS_PERMISSION_DENIED           0x7FFE
...
USHORT EMV_CardholderSelectionConfirmationSet(BYTE bMode);

USHORT EMV_DataInit(void);
USHORT EMV_VERIFYCommandSW12Get(BYTE *pbCMDStatus, BYTE *baSW12);
...
#define d_EVENTID_CVM_NO_PIN_ACTION									33
#define d_EVENTID_FINAL_SELECTION_CONFIRM							34
#define d_EVENTID_PIN_OTHER_KEYS									35
...
#define d_EVENTID_PINPAD_INFO										0xC4
#define d_EVENTID_TOTAL_AMOUNT_GET									0xC5
#define d_EVENTID_EXCEPTION_FILE_CHECK								0xC6
#define d_EVENTID_CAPK_REVOCATION_CHECK								0xC7
...
//variable for d_EVENTID_PINPAD_INFO
typedef USHORT (*EVENT_PINPAD_INFO)(IN USHORT usInfo, IN USHORT usInRFU, OUT USHORT *pusOutRFU);
//usInfo
//0xA5 - key ok pressed
//0xA6 - timeout
//0xA7 - key cancel pressed
//0xA8 - cancel PIN by API

//variable for d_EVENTID_PIN_OTHER_KEYS
typedef USHORT (*EVENT_PIN_OTHER_KEYS)(IN BYTE bKey, IN USHORT usInRFU, OUT USHORT *pusOutRFU);

//variable for d_EVENTID_CVM_NO_PIN_ACTION
typedef USHORT (*EVENT_CVM_No_PIN_Action)(IN BYTE bCVM, OUT BYTE *pbAction);
//pbAction
//0x01 - Stop transaction 
